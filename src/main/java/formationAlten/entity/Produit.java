...
@Entity
@Table(name="product")
@SequenceGenerator(name = "seqProduit", sequenceName = "product_seq_id", initialValue = 100, allocationSize = 1)
public class Produit {
	...
	private double prix;
	@ManyToOne
	@JoinColumn(name = "product_supplier_id", foreignKey = @ForeignKey(name ="fk_product_supplier_id"))
